    ...
    <motion.div
            ...
            backdrop-filter backdrop-blur-xl rounded-2xl shadow-xl overflow-hidden">
                 <div className="p-8">
                    ...
                    {!isSubmitted? (
                        <form onSubmit={handleForgotPassword}>
                            ...
                            required
                            />
                            {error && <p className="text-red-500 font-semibold mb-7">{error}</p>}
                            <motion.button
                    ...
                    (
                        <div className="text-center">
                            ...
                            intial={{scale:0}}
                            animate={{scale:1}}
                            transition={{type:"sprint",stiffness:500, damping:30}}
                 ...
                 <div className="px-8 py-4 bg-gray-900 bg-opacity-50 flex justify-center">
                    <Link to={"/login"} className="text-sm text-green-400 hour:underline flex items-center">
