  ...
  return (
    ...
    rounded-xl shadow-2xl border border-gray-800">
        ...
        <div className="space-y-6">
            ...
            >
                <h3 className="text-xl text-center font-semibold text-green-400 mb-3">Profile Information</h3>
            ...
            >
                <h3 className="text-center text-xl font-semibold text-green-400 mb-3">Account Activity</h3>
